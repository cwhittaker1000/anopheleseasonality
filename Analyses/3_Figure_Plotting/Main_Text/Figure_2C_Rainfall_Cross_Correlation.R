...
lines(timepoints, mean_monthly_sum_1, type = "l", col = adjustcolor(palette()[1], alpha.f = 0.75), lwd = 5)

mean_monthly_sum_2 <- apply(monthly_sum_rainfall_storage[cluster_labels$Cluster == 2, ], 2, mean)
lines(timepoints, mean_monthly_sum_2, type = "l", col = adjustcolor(palette()[2], alpha.f = 0.75), lwd = 5)

mean_monthly_sum_3 <- apply(monthly_sum_rainfall_storage[cluster_labels$Cluster == 3, ], 2, mean)
lines(timepoints, mean_monthly_sum_3, type = "l", col = adjustcolor(palette()[3], alpha.f = 0.75), lwd = 5)

mean_monthly_sum_4 <- apply(monthly_sum_rainfall_storage[cluster_labels$Cluster == 4, ], 2, mean)
lines(timepoints, mean_monthly_sum_4, type = "l", col = adjustcolor(palette()[4], alpha.f = 0.75), lwd = 5)
